    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      `}>
        <div className="flex flex-col h-full ">
          ...
          <div className="p-4 border-t border-emerald-800">
            <div className="p-4 space-y-3 text-sm bg-emerald-800/50 rounded-xl text-emerald-200">
              ...
              <button
                onClick={logout}
                className="flex items-center justify-center w-full gap-2 px-3 py-2 font-bold text-white transition-colors rounded-lg bg-emerald-950/50 hover:bg-emerald-950"
              >
                <LogOut size={16} />
                Logout
              </button>
      ...
      <main className="flex flex-col flex-1 min-w-0 overflow-hidden">
        ...
        <header className="flex items-center justify-between p-4 bg-white border-b lg:hidden">
          <div className="flex items-center gap-2">
            <Leaf className="text-emerald-800" size={24} />
        ...
        <div className="flex-1 p-4 overflow-y-auto lg:p-8">
          <Routes>
